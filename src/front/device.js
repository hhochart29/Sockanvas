...
let deltaY, startX, startY, x, y, deltaX, startTime, endTime, deltaTime, speed, angle
let data = {}
...
window.socket.on('deviceUpdateScore', (player, score) => {
  if (player === 'j1') {
    document.querySelector('#j1-device-score').innerHTML = score
  }
  else if (player === 'j2') {
    document.querySelector('#j2-device-score').innerHTML = score
  }
})
